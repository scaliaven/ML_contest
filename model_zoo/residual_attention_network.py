...
class ResidualAttentionModel_92_32input_update(nn.Module):
    ...
    def __init__(self):
        ...
        self.attention_module1 = AttentionModule_stage1_cifar(128, 128, size1=(128, 128), size2=(64, 64))  # 32*32
        self.residual_block2 = ResidualBlock(128, 256, 2)  # 16*16
        self.attention_module2 = AttentionModule_stage2_cifar(256, 256, size=(64, 64))  # 16*16
        self.attention_module2_2 = AttentionModule_stage2_cifar(256, 256, size=(64, 64))  # 16*16 # tbq add
